<link href="http://localhost/ShopOnline/public/content/style.css" rel="stylesheet" type="text/css" media="all" />
                                ...
                                <div class="cart-b">
                                    <div class="left-n ">
                                        ...
                                        <span class="item_price">
                                            <?php echo $product ? (($product['Price']) - ($product['Price']) * ($product['Percent_off']) / 100) : 0; ?></span>
                                        <span class="custom_price">Giá khuyến mại:
                                        ...
                                        <span class="custom_price">Giá bán :
                                            <?php echo $product ? number_format($product['Price'], 0, ',', '.') : 0; ?>
                                            VNĐ</span>
                                        <br>
                                        <?php endif ?>

                                        <a href="index.php?controller=cart&amp;action=add&amp;pid=<?php echo $product['Id']; ?>"
                                        ...
                                        <li>
                                            <a onClick="window.open('http://www.facebook.com/sharer.php?s=100&amp;p[title]=<?php echo $title; ?>&amp;p[summary]=<?php echo $summary; ?>&amp;p[url]=<?php echo $url; ?>&amp;&p[images][0]=<?php echo $image; ?>', 'sharer', 'toolbar=0,status=0,width=548,height=325');"
                                                target="_parent" href="javascript: void(0)"><img
                                                    src="public/content/facebook.png" title="facebook"></a>
                                        </li>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="home">
                                        <div class="fb-comments" data-href="http://shop90er.esy.es/" data-width="550"
