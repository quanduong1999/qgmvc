            ...
            <table class="tableProduct">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo '<image src="public/upload/product/' . $product['Image1'] . '?time=' . time() . '" style="max-width:50px;" />'; ?></a>
                        </td>
                        ...
                        <td>
                            ...
                            <a
                                href="admin.php?controller=product&amp;action=delete&amp;pid=<?php echo $product['Id']; ?>"><span>remove</span></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
