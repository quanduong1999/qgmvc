    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="dataTable_wrapper"><?php var_dump($user_info['Id']); ?>
                ...
                <form id="user-form" class="form-horizontal" method="post" action="admin.php?controller=user&action=add"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="username" type="text"
                                value="<?php echo $user_info ? $user_info['Username'] : ''; ?>" class="form-control"
                                id="Username" placeholder="Họ và tên" required="" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="password" type="text"
                                value="<?php echo $user_info ? $user_info['Password'] : ''; ?>" class="form-control"
                                id="Password" placeholder="Địa chỉ" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="name" type="text" value="<?php echo $user_info ? $user_info['Name'] : ''; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="roleid" type="text"
                                value="<?php echo $user_info ? $user_info['RoleId'] : ''; ?>" class="form-control"
                                id="RoleId" placeholder="RoleId" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="email" type="text" value="<?php echo $user_info ? $user_info['Email'] : ''; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="address" type="text"
                                value="<?php echo $user_info ? $user_info['Address'] : ''; ?>" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="phone" type="text" value="<?php echo $user_info ? $user_info['Phone'] : ''; ?>"
                                class="form-control" id="phone" placeholder="Số di động" pattern="[0-9]{10,11}" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                            <button type="submit"
                                class="btn btn-primary"><?php echo $user_info ? 'Cập nhật' : 'Thêm mới'; ?></button>
